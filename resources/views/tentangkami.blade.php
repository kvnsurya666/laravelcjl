                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="/img/testimonials-2.jpg" alt="Sales 1" />
                            <h5>Pak Edi</h5>
                    ...
                    <div class="col-lg-3">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="/img/Sales/sales2.jpg" alt="Sales 2" />
                            <h5>Pak Ilyas</h5>
                            <div class="phone-domain">
                              <div style="padding: 6px 10px">
                                  <img src="/assets/img/whatsapp-original.png" alt="" style="margin-right: 5px; height: 30px; width: 30px" /><span class="" style="float: left; background-color: #25d366"></span>
